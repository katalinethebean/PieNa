...
function buildPrompt(extractedText, position, motion, context) {
  ...
  return `你是一位专业辩论赛评委，请严格按照以下评分标准对辩手发言进行评估。
...

{
  ...
  "appeal": 0.0,
  "overall": 0.0,
  "feedback_summary": "2–3句总体评价，指出最突出的优点",
...
- 指出对方哪些具体论点被忽略、未回应或回避了
- 指出发言中出现的逻辑矛盾、立场漂移或自相矛盾之处
- 指出哪些反驳或论证做得准确有效，说明为什么有效
- 给出可操作的改进建议，说明"应该怎么做"而非"建议加强某方面"
禁止：直接引用原文段落、泛泛说"建议加强"、重复描述已发生的事情。
